...
{path:"module/settings_server.html#settings_server.canCollectPickup", type:"function", title:"settings_server.canCollectPickup", text:"*(Exported)* PS: Valid player account check is elsewhere in the code already"},
...
{path:"module/settings_server.html#settings_server.canAdminCollectibles", type:"function", title:"settings_server.canAdminCollectibles", text:"*(Exported)*"},
...
{path:"module/system_server.html#system_server.parseCustomSettings", type:"function", title:"system_server.parseCustomSettings", text:"Validates all custom settings returns true if successful, false + error message otherwise."},
